...
using TravelManagementSystem.Data.Seeders;
...
namespace TravelManagementSystem.Infrastructure.Startup
{
    ...
    public class DbSeederHostedService : IHostedService
    {
        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            {
                await IdentityDataSeeder<AppUser, AppRole>.SeedDataAsync(
