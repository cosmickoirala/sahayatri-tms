...
namespace TravelManagementSystem.Controllers
{
...

    {
        ...
        public RatingReviewController(ApplicationDbContext _db , IWebHostEnvironment _webHost)
        {
            db = _db;
            webHost=_webHost;
        }
        ...
        [HttpPost]
        public IActionResult Rate(PlaceModel place)
        {
             db.Places.Find(Convert.ToInt32(place.Place.Id));
